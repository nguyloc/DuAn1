...
namespace Player.PlayerStates.SubStates
{
    public class PlayerLedgeClimbState : PlayerState
    {
        ...
        public PlayerLedgeClimbState(StateMachine.Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
        {
        }
