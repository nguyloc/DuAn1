...
namespace Player.PlayerStates.SubStates
{
    public class PlayerDashState : PlayerAbilityState
    {
        ...
        public PlayerDashState(StateMachine.Player player, PlayerStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
        {
        }
